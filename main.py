...
def extraire_info_recette(url):
    ...
    licence_valide = "cc0" in license_text.lower() or "domaine public" in license_text.lower()
...
url = "https://www.cuisine-libre.org/boulangerie-et-patisserie?mots%5B%5D=83&mots%5B%5D=&max=200"
